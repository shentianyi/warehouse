...
ActiveRecord::Schema.define(version: 20161011040727) do
  ...
  create_table "containers", force: true do |t|
    ...
    t.integer  "extra_nps_count",                      default: 0
    t.string   "extra_carrier"
    t.string   "extra_custom_name"
    t.string   "extra_destination_address"
    t.datetime "extra_delivery_date"
    t.datetime "extra_arrive_date"
  end
  ...
  create_table "wrappage_movement_items", force: true do |t|
  ...
  add_index "wrappage_movement_items", ["sourceable_id"], name: "index_wrappage_movement_items_on_sourceable_id", using: :btree
  add_index "wrappage_movement_items", ["sourceable_type"], name: "index_wrappage_movement_items_on_sourceable_type", using: :btree
  ...
  add_index "wrappage_movements", ["package_type_id"], name: "index_wrappage_movements_on_package_type_id", using: :btree
  add_index "wrappage_movements", ["user_id"], name: "index_wrappage_movements_on_user_id", using: :btree
