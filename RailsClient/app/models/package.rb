class Package < ActiveRecord::Base
  ...
  def self.entry_report condition
    ...
    .where(condition)
    .select("packages.state as state,packages.part_id,COUNT(packages.id) as box_count,SUM(packages.quantity_str) as total,forklifts.whouse_id as whouse_id,deliveries.created_date as rdate,deliveries.receiver_id as receover_id")
