class PartsController < ApplicationController
  ...
  def part_params
    #params[:part]
    params.require(:part).permit(:id, :unit, :unit_pack, :customernum, :user_id, :part_type_id, :is_delete, :convert_unit, :description, :supplier,
                                 :mustCheck, :checkpattem, :isProducable, :isFinalProduct, :isWipProduct, :isPurchasable, :isSalable)
  end
