...
RSpec.describe "storage_operation_records/new", type: :view do
  before(:each) do
    assign(:storage_operation_record, StorageOperationRecord.new(
      :partNr => "MyString",
      :qty => "MyString",
      :fromWh => "MyString",
  ...
  it "renders new storage_operation_record form" do
    render

    assert_select "form[action=?][method=?]", storage_operation_records_path, "post" do
