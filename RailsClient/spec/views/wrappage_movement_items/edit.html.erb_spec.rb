...
RSpec.describe "wrappage_movement_items/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit wrappage_movement_item form" do
    render

    assert_select "form[action=?][method=?]", wrappage_movement_item_path(@wrappage_movement_item), "post" do
