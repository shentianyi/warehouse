...
p1 = Position.create(id:'ps001',whouse_id:'WH001',detail:'01 01 04')
p2 = Position.create(id:'ps002',whouse_id:'WH002',detail:'03 02 04')
...
PartPosition.create(part_id:'PT002',position_id:p2.id,whouse_id:'wh002')
